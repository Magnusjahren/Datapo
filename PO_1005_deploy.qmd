...
Figuren viser regresjon av salg og profitt for alle utsalgene. Regresjonen viser sammenhengen mellom salg og profitt. Koeffisienten har stigningstallet 0.066, som baseres på hver dollar av salg. Det kan være interessant dersom skal projektere en økning av totalt utsalg. Dersom de ønsker 1000 dollar mer i profitt, må det økes salg med omtrent 15000 dollar.
...
df_reg %>% 
  ...
  labs(x = "Sales in USD", y = "Profit in USD", title = "Regression of sales and profit")                                  #Add regression line
```
