...
Vær sikker over hva plotsene skal vise, ikke gjør det overkomplisert

Vær forsiktig med pie-chart helst bare 2 ting som sammenlignes og husk å vise prosent slik at det er lett leselig

Vær konsistent på alle plots små store bokstaver, tydelig tittel, benevning og verdi som aksene viser

Kanskje sammenligne salg med kvinner, menn? Unge voksne, eldre? familier med barn, single? 

Prøve å lage funksjon med de 5 største ølmerkene mtp salg

Vi har laget mange plots med sales, kanskje bruke andre variabler, f.eks antall? Hva er mest profitabelt/antall av 6 pakninger mot 12pakk eller andre.
